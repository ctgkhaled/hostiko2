        ...
        <section class="footer-box w-100 padding_top_70 padding_bottom_70">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 footer_box">
                        <h5 class="font-18 text-white mb-20 font-bold text-uppercase"">Legal</h5>
                        <ul class="font_size_14 font_weight_400 line_height_22 footer_links list-inline">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 footer_box">
                        <h5 class="font-18 text-white mb-20">whmcs</h5>
                        <ul class="font_size_14 font_weight_400 line_height_22 footer_links list-inline">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 footer_box col-xs-4 footer_social_links_box">
                        <h5 class="font-18 text-white mb-20">Social Links</h5>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 footer_logo_box">
                        <figure class="padding_bottom_10">
                            <img class="img-fluid" src="{$WEB_ROOT}/templates/{$template}/layouts/wp-02/assets/images/logo02.png" />
                        </figure>
                        <h6 class="copyright">Copyright @ 2019 <span><a href="#">Hostiko.com</a></span> <br> All RIght Reserved</h6>
                    </div>
                </div>
            </div>
        </section>
