            ...
            <div class="container">
                ...
                <div class="row padding_bottom_30">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 footer_box">
                        <h5 class="font-18 text-dark mb-20">Our Services</h5>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 footer_box">
                        <h5 class="font-18 text-dark mb-20">Company</h5>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 footer_box">
                        <h5 class="font-18 text-dark mb-20">Support</h5>
                        <ul class="font_size_14 font_weight_400 line_height_22 footer_links list-inline">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 footer_box">
                        <h5 class="font-18 text-dark mb-20">Get In Touch With Us</h5>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 footer_box">
                        <h5 class="font-18 text-dark mb-20 font-bold text-uppercase"">Legal</h5>
                        <ul class="font_size_14 font_weight_400 line_height_22 footer_links list-inline">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 footer_box">
                        <h5 class="font-18 text-dark mb-20">whmcs</h5>
                        <ul class="font_size_14 font_weight_400 line_height_22 footer_links list-inline">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 footer_box col-xs-4 footer_social_links_box">
                        <h5 class="font-18 text-dark mb-20">Social Links</h5>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 footer_logo_box">
                        <figure class="padding_bottom_10">
                            <a href="#"><img class="img-fluid" src="{$WEB_ROOT}/templates/{$template}/layouts/wp-18/assets/images/logo18.png" /></a>
                        </figure>
